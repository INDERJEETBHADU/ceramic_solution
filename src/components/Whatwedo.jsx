...
const Whatwedo = () => {
  return (
    <div id="about" className="max-w-[1920px] mx-auto">
          ...
          {WHAT_WE_DO_CARD.map((data, index) => (
            <div key={index} className="flex justify-center col-4 pt-6">
              <div className="max-w-[364px] flex flex-col justify-between w-full rounded-3xl shadow-3xl p-6">
                <div>
                  <img className="rounded-3xl" src={data.img} alt="card-img" />
            ...
            {WHAT_WE_DO_CARD.map((data, index) => (
              <SwiperSlide key={index}>
                <div className="flex justify-center p-5 mb-6">
                  <div className="max-w-[364px] w-full rounded-3xl shadow-3xl p-6 max-sm:min-h-[456px] flex flex-col justify-between">
                    <div>  <img className="rounded-3xl max-w-[294px] w-full max-sm:h-[246px]" src={data.img} alt="card-img" />
