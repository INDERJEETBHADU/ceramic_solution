  ...
  return (
    <div id="portfolio" className="container pt-xxl max-lg:pt-20">
      ...
      <div className="xl:hidden blog_swiper">
        ...
        >
          {BLOG_CARD.map((data, Blog) => (
            <SwiperSlide key={Blog} className="!flex !justify-center pb-xxl max-lg:pb-20 mt-14 max-lg:mt-8">
              <div
                className="shadow-[0px_0px_12px_3px_#B6B6B640] flex flex-col justify-between rounded-3xl p-[24px] bg-white max-w-[364px] w-full min-h-[474px]"
              >
                <div>
                <img
                  className="rounded-3xl max-w-[316px] w-full"
